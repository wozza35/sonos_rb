...
describe SonosRB::SOAP::Request do
  ...
  describe '#perform' do
    ...
    context 'with args' do
      ...
      let(:unit) { described_class.new(uri, operation, namespace, args) }

      it 'includes args in the request body' do
        expected_body = SonosRB::SOAP::Envelope.new(operation, namespace, args).to_xml
